...
export const VIEWS: Record<string, ViewDef> = {
  ...
  bigwinners: { label: "Big Winners · ≥$20K", short: "Big Winners", icon: "trend-up",
                group: "Daily Triggers", key: "bigWinners",
                sub: "Players who won $20K+ yesterday" },
  biglosers:  { label: "Big Losers · ≥$5K", short: "Big Losers", icon: "trend-down",
                group: "Daily Triggers", key: "bigLosers",
                sub: "Players who lost $5K+ to the house yesterday" },
  rd:         { label: "Pending Redemptions", short: "Pending RD", icon: "banknote",
                group: "Daily Triggers", key: "rdOver5k",
                sub: "Locked withdrawals awaiting release" },
  rdfirst:    { label: "First-Time Locked RD", short: "First-Time RD", icon: "sparkles",
  ...
  locks:      { label: "Locked & Take A Break", short: "Lock & TAB", icon: "lock",
